  ...
  useEffect(() => {
    ...
    el.textContent = `
      ...
      *{margin:0;padding:0;box-sizing:border-box;}
      ...
      .cm-perk{display:flex;align-items:flex-start;gap:14px;}
      .cm-perk-icon{
      ...
      .cm-perk-title{font-weight:600;font-size:14px;color:#2e1065;margin-bottom:2px;}
      .cm-perk-desc{font-size:13px;font-weight:300;color:#6d28d9;opacity:.7;line-height:1.5;}
